...
//  修改兼容性到jquery1.5，主要修改的是事件和事件名称的不兼容    by  hsir
!function(t, i) {
    ...
    var $ = "undefined" != typeof window ? window : {}
      , B = "cropper-hidden"
      , k = $.PointerEvent ? "mousedown" : "mousedown"
      , W = $.PointerEvent ? "mousemove" : "mousemove"
      , T = $.PointerEvent ? "mouseup" : "mouseup"
      ...
      , q = {
        bindf: function() {
            var i = this.$element
              , e = this.options
              , a = this.$cropper;
            t.isFunction(e.cropstart) && i.bind("cropstart", e.cropstart),
            t.isFunction(e.cropmove) && i.bind("cropmove", e.cropmove),
            t.isFunction(e.cropend) && i.bind("cropend", e.cropend),
            t.isFunction(e.crop) && i.bind("crop", e.crop),
            t.isFunction(e.zoom) && i.bind("zoom", e.zoom),
            a.bind(k, o(this.cropStart, this)),
            e.zoomable && e.zoomOnWheel && a.bind("wheel mousewheel DOMMouseScroll", o(this.wheel, this)),
            e.toggleDragModeOnDblclick && a.bind("dblclick", o(this.dblclick, this)),
            t(document).bind(W, this.onCropMove = o(this.cropMove, this)).bind(T, this.onCropEnd = o(this.cropEnd, this)),
            e.responsive && t(window).bind("resize", this.onResize = o(this.resize, this))
        },
        unbindf: function() {
            var i = this.$element
              , e = this.options
              , a = this.$cropper;
            t.isFunction(e.cropstart) && i.unbind("cropstart", e.cropstart),
            t.isFunction(e.cropmove) && i.unbind("cropmove", e.cropmove),
            t.isFunction(e.cropend) && i.unbind("cropend", e.cropend),
            t.isFunction(e.crop) && i.unbind("crop", e.crop),
            t.isFunction(e.zoom) && i.unbind("zoom", e.zoom),
            a.unbind(k, this.cropStart),
            e.zoomable && e.zoomOnWheel && a.unbind("wheel mousewheel DOMMouseScroll", this.wheel),
            e.toggleDragModeOnDblclick && a.unbind("dblclick", this.dblclick),
            t(document).unbind(W, this.onCropMove).unbind(T, this.onCropEnd),
            e.responsive && t(window).unbind("resize", this.onResize)
        }
    }
      , Q = {
        resize: function() {
      ...
      , Z = {
        ...
        destroy: function() {
            ...
            this.unbuild(),
            t.removeClass(B)) : this.isImg ? t.unbind("load", this.start) : this.$clone && this.$clone.remove(),
        ...
        return V(i, [{
                ...
                if (t) {
                    ...
                    if (a.checkOrientation && window.ArrayBuffer)
                        if (H.test(t))
                            ...
                            ,
                            a.checkCrossOrigin && r(t) && e.data("crossOrigin") && (t = s(t)),
                            n.open("get", t),
                            n.responseType = "arraybuffer",
                            n.withCredentials = "use-credentials" === e.data("crossOrigin"),
                            n.send()
                        }
                    else
                        this.clone()
            ...
            value: function() {
                var i = this.$element
                  ...
                  , n = ""
                  , o = void 0;
                e.checkCrossOrigin && r(a) && ((n = i.data("crossOrigin")) ? o = a : (n = "anonymous",
                o = s(a))),
                this.crossOrigin = n,
            ...
            value: function() {
                var i = this
                  , e = this.$clone
                  , a = this.$element;
                this.isImg || (e.unbind("error", this.stop),
                a = e),
                d(a[0], function(e, a) {
                    t.extend(i.image, {
                        naturalWidth: e,
